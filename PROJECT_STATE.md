...
- The controlled OİS test fixture preserves the administrator's explicitly validated 13.07.2026 packet (`hafta: 1`, absent `saat: 2`, present `Usaat: 0`) solely to validate the test-host contract. It does not alter the general academic-calendar mapping used by normal courses.
